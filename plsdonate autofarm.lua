...
queueonteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/slapslap1/boblox/main/plsdonate%20autofarm.lua'))()")
...
function update()
    ...
    if Raised.Value > 999 then
        ...
        boothText = tostring('<font color="'.. getgenv().settings.hexBox.. '">Buy so-called "stuff" here! Anything helps! <font color=" #00FF00 "> GOAL: ' .. Raised.Value .. " / " .. text .. "</font>")
    end
